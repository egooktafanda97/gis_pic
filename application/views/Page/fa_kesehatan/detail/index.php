                    ...
                    <div class="child-one-grids-detail">
                        ...
                        <div class="card-body">
                            <div class="flex-space-between item-container-detail">
                                <div class="item-detail l-title">Type Fasilitas</div>
                                <div class="item-detail"><?= $val['type_fasilitas'] ?? "" ?></div>
                            </div>
                            <div class="flex-space-between item-container-detail">
                                <div class="item-detail l-title">Nama Jenis Fasilitas</div>
                                <div class="item-detail"><?= $val['nama_jenis_fasilitas'] ?? "" ?></div>
                            </div>
                            <div class="flex-space-between item-container-detail">
                                <div class="item-detail l-title">Nama Fasilitas</div>
                                <div class="item-detail"><?= $val['nama_fasilitas'] ?? "" ?></div>
                            </div>
                            <div class="flex-space-between item-container-detail">
                                <div class="item-detail l-title">Alamat Fasilitas</div>
                            ...
                            <div class="flex-space-between item-container-detail">
                                <div class="item-detail l-title">Jumlah Pasien Rata-rata</div>
                                <div class="item-detail"><?= $val['jumlah_pasien_rata'] ?? "" ?></div>
                            </div>
                            <div class="flex-space-between item-container-detail">
